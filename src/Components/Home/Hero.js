...
const Button = tw(Link)` bg-ssorange hover:brightness-60 cursor-pointer text-white mr-4 py-4 rounded-xl font-bold hover:shadow-md  text-center w-[100%] md:!w-[200px]   `
