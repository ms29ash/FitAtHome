      ...
      <Wrapper>
        <Container>
          ...
          <Text>
            ...
            <SubText>
              Unlock Your Journey to a Fitter, Healthier You with Sweet and
              Savory Nutritious Delights!
            </SubText>
          </Text>
          <Buttons>
            <Button to="/menu">
              <p className=" relative z-10">Check the Menu</p>{" "}
            </Button>
...
const Button = tw(
  Link
)` bg-ssorange cursor-pointer text-white mr-4 py-4  w-[100%] md:!w-[200px] before:bg-ssgreen hover-btn `;
