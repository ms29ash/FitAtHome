      ...
      <Wrapper>
        ...
        <Group ref={refGroup}>
          ...
          <Option>
            ...
            />
            <OptionText $typeOf={type === null} htmlFor="all">
              All
            </OptionText>
          </Option>
          <Option>
            ...
            />
            <OptionText $typeOf={type === "Veg"} htmlFor="veg">
              Veg
            </OptionText>
          </Option>
          <Option>
            ...
            />
            <OptionText $typeOf={type === "Non-Veg"} htmlFor="non-veg">
              Non-Veg
            </OptionText>
          </Option>
          <Option>
            ...
            />
            <OptionText $typeOf={type === "Vegan"} htmlFor="vegan">
              Vegan
            </OptionText>
          </Option>
          {/* <Option>
...
const OptionText = tw.label` text-sm  font-bold  -ml-2 w-full py-3 text-center cursor-pointer   bg-slate-100 rounded transition-all duration-200 ${(
  p
) => (p.$typeOf ? "bg-black text-white" : "hover:bg-slate-200 text-black/80")}
`;
