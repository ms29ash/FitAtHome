...
const Container = tw.div`flex items-center justify-between w-[98%] h-[20%] border-b-2 border-b-black `
...
const Btn = tw(Button)`w-20 border-redfood border-[2px] !bg-white text-black hover:text-white`
